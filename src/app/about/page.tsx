    ...
    <div className="min-h-screen w-full bg-background dark:bg-gradient-animated font-body antialiased">
      ...
      <main className="relative z-10 max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 space-y-24">
        ...
        <section className="text-center pt-24 pb-12">
          <h1 className="text-6xl sm:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-foreground/80 to-foreground animate-fade-in-down dark:from-neutral-50 dark:to-neutral-400">
            QR Genie <span className="text-cyan-400">🔮</span>
          </h1>
          <p className="mt-6 text-xl text-muted-foreground dark:text-neutral-300 max-w-2xl mx-auto animate-fade-in-up">
        ...
        {/* About the Tool */}
        <section className="p-8 bg-card/50 dark:bg-black/20 backdrop-blur-md border border-border dark:border-white/10 rounded-2xl shadow-lg animate-fade-in">
          <h2 className="text-4xl font-bold text-center mb-6 text-cyan-400">About the Tool</h2>
          <p className="text-lg text-muted-foreground dark:text-neutral-300 text-center max-w-3xl mx-auto">
        ...
        {/* About Developer */}
        <section className="p-8 bg-card/50 dark:bg-black/20 backdrop-blur-md border border-border dark:border-white/10 rounded-2xl shadow-lg">
