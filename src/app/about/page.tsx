    ...
    <div className="min-h-screen w-full bg-gradient-animated text-white font-body antialiased">
      ...
      <main className="relative z-10 max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 space-y-24">
        ...
        <section className="text-center pt-24 pb-12">
          <h1 className="text-6xl sm:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 animate-fade-in-down">
            QR Genie <span className="text-cyan-400">🔮</span>
          </h1>
          <p className="mt-6 text-xl text-neutral-300 max-w-2xl mx-auto animate-fade-in-up">
        ...
        {/* About the Tool */}
        <section className="p-8 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg animate-fade-in">
          <h2 className="text-4xl font-bold text-center mb-6 text-cyan-400">About the Tool</h2>
        ...
        {/* How to Use */}
        <section>
          <h2 className="text-4xl font-bold text-center mb-12 text-cyan-400">How to Use</h2>
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg transition-all duration-300 hover:border-cyan-400 hover:scale-105 hover:shadow-cyan-500/20">
              <div className="flex justify-center items-center h-16 w-16 rounded-full bg-cyan-900/50 border-2 border-cyan-500 text-cyan-300 mx-auto mb-4">
                <span className="text-2xl font-bold">1</span>
              </div>
              <h3 className="text-xl font-semibold mb-2">Enter Content</h3>
              <p className="text-neutral-400">Input your URL or text into the field.</p>
            </div>
            <div className="p-6 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg transition-all duration-300 hover:border-cyan-400 hover:scale-105 hover:shadow-cyan-500/20">
              <div className="flex justify-center items-center h-16 w-16 rounded-full bg-cyan-900/50 border-2 border-cyan-500 text-cyan-300 mx-auto mb-4">
              ...
              <p className="text-neutral-400">Adjust the color, size, and style to match your brand.</p>
            </div>
            <div className="p-6 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg transition-all duration-300 hover:border-cyan-400 hover:scale-105 hover:shadow-cyan-500/20">
              <div className="flex justify-center items-center h-16 w-16 rounded-full bg-cyan-900/50 border-2 border-cyan-500 text-cyan-300 mx-auto mb-4">
              ...
              <p className="text-neutral-400">Click generate and download your QR code as a PNG.</p>
            </div>
          </div>
        </section>
        ...
        {/* Tech Stack */}
        <section>
          <h2 className="text-4xl font-bold text-center mb-12 text-cyan-400">Tech Stack</h2>
        ...
        {/* About Developer */}
        <section className="p-8 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl shadow-lg">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-lg text-cyan-400 mt-1">B.Tech AIML Student & Frontend Developer</p>
              <div className="flex justify-center md:justify-start gap-4 mt-6">
                <a href="https://github.com/Kishan779-art" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-cyan-400 transition-colors"><Github size={28} /></a>
                <a href="https://www.instagram.com/kishan_patel_7799_/" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-cyan-400 transition-colors"><Instagram size={28} /></a>
                <a href="https://wa.me/918200094510" target="_blank" rel="noopener noreferrer" className="text-neutral-300 hover:text-cyan-400 transition-colors"><Send size={28} /></a>
              </div>
